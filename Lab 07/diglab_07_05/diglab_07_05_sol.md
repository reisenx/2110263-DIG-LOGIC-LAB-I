...
จากตารางเราจะสรุปได้ว่า $D = T \oplus Q_{t}$ นั่นเอง และสามารถดัดแปลง Negative Edge Trigger D Flip-flop ให้เป็น Negative Edge Trigger D Flip-flop ได้ ดังภาพ
